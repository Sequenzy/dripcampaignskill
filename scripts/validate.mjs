...
const required = [
  ...
  "public/skills/dripcampaignskill/SKILL.md",
  "public/.well-known/skills/dripcampaignskill/SKILL.md",
  "public/.well-known/agent-skills/dripcampaignskill/SKILL.md",
...
const skill = fs.readFileSync("skills/dripcampaignskill/SKILL.md", "utf8");
if (!skill.startsWith("---\nname: dripcampaignskill\n")) throw new Error("Invalid skill frontmatter");
const html = fs.readFileSync("public/index.html", "utf8");
if (!html.includes("npx skills add dripcampaignskill")) throw new Error("Missing install shortcut");
...
if (!markdown.includes("npx skills add dripcampaignskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "dripcampaignskill") throw new Error("Invalid well-known skills index");
